    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('telega', models.CharField(help_text='Введите ссылку/логин в Telegram', max_length=30, verbose_name='Telegram')),
            ],
        ),
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('zn', models.CharField(help_text='Введите ЗАВОДСКОЙ номер', max_length=30, primary_key=True, serialize=False, verbose_name='Заводской номер')),
        ...
        migrations.CreateModel(
            name='FiscalStorage',
            fields=[
                ('number', models.CharField(help_text='Введите заводской номер ФН', max_length=16, primary_key=True, serialize=False, verbose_name='Заводской номер')),
                ('validity', models.DateField(blank=True, help_text='Введите дату окончания ФН', null=True, verbose_name='Срок действия ФН')),
                ('model', models.CharField(help_text="Введите модель ФН(Например: 'Ин15-3'", max_length=16, verbose_name='Модель')),
            ],
            options={
                'ordering': ['number'],
            },
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('inn', models.IntegerField(help_text='Введите ИНН ОФД', max_length=10, verbose_name='ИНН')),
                ...
                ('timeout', models.CharField(blank=True, help_text='Таймаут чтения', max_length=3, null=True, verbose_name='Таймаут чтения')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('sn', models.IntegerField(blank=True, help_text='Введите серийный номер принтера (необязательно)', max_length=30, null=True, verbose_name='Серийный номер')),
                ('name', models.CharField(blank=True, help_text='Введите имя в iiko (Например отделение, где размещен принтер', max_length=20, null=True, verbose_name='Имя в iiko')),
            ],
        ),
        migrations.CreateModel(
            name='RDP',
            fields=[
                ...
                ('other', models.CharField(blank=True, help_text='Введите дополнительные сведения', max_length=500, null=True, verbose_name='Доп. сведения')),
            ],
        ),
        migrations.CreateModel(
            name='TypeEq',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('stname', models.CharField(help_text='Введите имя как в iiko', max_length=20, verbose_name='Имя станции')),
                ...
                ('fr', models.ManyToManyField(blank=True, help_text='Выберите ФР, если он(они) подключен к этой станции', null=True, to='rezon.fiscalregistrar', verbose_name='Фискальный регистратор')),
                ('optequip', models.ManyToManyField(blank=True, help_text='Выберите доп оборудование, если оно привязано к это станции', null=True, to='rezon.optequip', verbose_name='Доп. оборудование')),
                ('printers', models.ManyToManyField(blank=True, help_text='Выберите принтер или принтеры, если они привязаны к это станции', null=True, to='rezon.printers', verbose_name='Принтеры')),
            ],
        ),
        migrations.AddField(
            model_name='optequip',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('photo', models.ImageField(blank=True, help_text='Прикрепите фото заведения (необязательно)', null=True, upload_to='images', verbose_name='Фото заведения')),
                ('contact', models.ForeignKey(help_text='Выберите контактное лицо', on_delete=django.db.models.deletion.DO_NOTHING, to='rezon.contact', verbose_name='Контактное лицо')),
                ('stations', models.ForeignKey(help_text='Выберите станции, установленные в этом заведении', on_delete=django.db.models.deletion.DO_NOTHING, to='rezon.station', verbose_name='Станции')),
            ],
        ),
        migrations.CreateModel(
            name='Corporation',
            fields=[
                ...
                ('iiko_server', models.GenericIPAddressField(help_text='Введите адрес сервера', verbose_name='Сервер iiko')),
                ...
                ('establishments', models.ForeignKey(help_text='Выберите Предприятие', on_delete=django.db.models.deletion.DO_NOTHING, to='rezon.establishment', verbose_name='Предприятие')),
