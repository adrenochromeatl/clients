    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('other', models.CharField(blank=True, help_text='Добавьте заметку', max_length=200, null=True, verbose_name='Примечание')),
                ('fr', models.ManyToManyField(blank=True, help_text='Выберите ФР, если он(они) подключен к этой станции', null=True, related_name='+', to='rezon.fiscalregistrar', verbose_name='Фискальный регистратор')),
                ('optequip', models.ManyToManyField(blank=True, help_text='Выберите доп оборудование, если оно привязано к это станции', null=True, related_name='+', to='rezon.optequip', verbose_name='Доп. оборудование')),
                ('printers', models.ManyToManyField(blank=True, help_text='Выберите принтер или принтеры, если они привязаны к это станции', null=True, related_name='+', to='rezon.printers', verbose_name='Принтеры')),
            ],
        ),
        migrations.AddField(
            model_name='optequip',
